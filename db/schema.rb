...
ActiveRecord::Schema.define(version: 2018_09_03_184425) do
  ...
  create_table "book_histories", force: :cascade do |t|
    ...
    t.index ["order_status_id"], name: "index_book_histories_on_order_status_id"
  end
